...
public class HashMap<K,V> extends AbstractMap<K,V>
    ...
    /**
     * HashMap的putVal方法主要是负责实现键值对存放的。
     *
     * @param hash 键的hashCode
     * @param key 键
     * @param value 值
     * @param onlyIfAbsent 如果为true，那么在键已经存在的情况下不会替换老的值
     * @param evict 如果为true，则表明正在执行map的创建或者扩容
     */
        ...
        if ((p = tab[i = (n - 1) & hash]) == null)
            ...
            if (p.hash == hash &&
                ...
                for (int binCount = 0; ; ++binCount) {
                    ...
                    // 如果链表中已经存在键值对的键与新添加的键相等的节点，则退出循环
                    if (e.hash == hash &&
                            ((k = e.key) == key || (key != null && key.equals(k))))
                        break;
                    p = e;
